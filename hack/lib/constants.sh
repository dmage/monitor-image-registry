...
readonly OS_GO_PACKAGE=github.com/dmage/monitor-image-registry
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-monitor-image-registry" images/monitor-image-registry
}
