...
%global package_name openshift-monitor-image-registry
%global product_name OpenShift Monitor Image Registry
%global import_path github.com/dmage/monitor-image-registry
...
for bin in monitor-image-registry
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/monitor-image-registry
